...
namespace PollBot {
    ...
    public partial class Config {
        ...
        public class Translation {
            ...
            [Required, YamlMember(Alias = "error-permissionwithauthor")]
            public string PermissionWithAuthorError { get; set; } = "error-permissionwithauthor";
